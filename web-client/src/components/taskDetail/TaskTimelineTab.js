...
import { Button, Card, Col, DatePicker, Descriptions, Modal, Popconfirm, Row, Select, Space, Tooltip, Typography, } from 'antd';
...
const PLANNED_STATES = new Set(['PLANNED_START', 'PLANNED_END']);
/** Renders the timeline cards for all four timeline states plus the set/edit modal. */
export function TaskTimelineTab({ timelines, deletingTlState, openTlModal, handleDeleteTimeline, tlModalOpen, setTlModalOpen, editingState, tlUserId, setTlUserId, tlTimestamp, setTlTimestamp, savingTimeline, handleSaveTimeline, users, phaseName, }) {
