...
/**
 * Permits all HTTP-level requests to the WebSocket handshake paths ({@code /ws/**}).
 *
 * <p>SockJS negotiation (e.g. {@code GET /ws/info}) and the WebSocket upgrade request
...
public class WebSocketHttpSecurityConfig {
    ...
    /**
     * Higher-priority filter chain that opens {@code /ws/**} at the HTTP layer.
